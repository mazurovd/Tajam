...
function BorderCorrect() {
    ...
    for (var i = 0; i <= ExpertItems.length - 1; i++) {
        ...
        ExpertItems[i].classList.remove("ExBorderLeft");
    }
    ...
    for (var y = ExpertItems.length - 1; y >= (ExpertItems.length - 1) - countResB; y--) {
        ExpertItems[y].classList.remove("ExBorderBottom");
    }
}
